...
import { ArrowLeftRegular, ArrowRightRegular, ArrowForwardDownPersonRegular, Checkmark24Regular } from '@fluentui/react-icons'
            ...
            <Card className='homepage-card'>
                ...
                {home3 && (
                    <div className='homepage-cardfield'>
                        ...
                        It could be IDS modules, log modules, etc ... <br></br>
                        <br></br>

                        <div className='homepage-animation2'>
                            <div className='homepage-animation2-box1'>Module</div>
                            <div className='homepage-animation2-box2'>Module</div>
                            <div className='homepage-animation2-box3'>Module</div>
                            ...
                            <div className='homepage-animation2-packet1-5-out'></div>
                            <div className='homepage-animation2-packet1-5-out-text'>Abnormal<ArrowRightRegular /></div>
                            ...
                            <div className='homepage-animation2-packet1-15-out'></div>
                            <div className='homepage-animation2-packet1-15-out-text'>Abnormal<ArrowRightRegular /></div>
                ...
                {home4 && (
                    <div className='homepage-cardfield'>
                        ...
                        <br></br>
                        <div className='homepage-animation2'>
                            <img src='license_gpl.png' className='homepage-license'></img>
                        </div>
                        <div className='homepage-button'>
                            <Button appearance='secondary' icon={<ArrowLeftRegular />} iconPosition="before" onClick={switchTo3}>Back</Button>
                            <Button appearance='primary' icon={<Checkmark24Regular />} iconPosition="after" onClick={switchReset}>Done</Button>
                        </div>
                    </div>
                )}
            </Card>
